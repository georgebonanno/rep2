...
locationMappings <- list(
  ...
  "BUSKETT"="RABAT",
  "BALLUTA"="SLIEMA",
  "STA MARIA ESTATE"="MELLIEĦA",
  "BINĠEMMA"="MĠARR",
  "SANTA MARIJA"="MELLIEĦA",
  "BAĦAR IĊ-ĊAGĦAQ"="BAHAR IĊ-ĊAGĦAQ",
  "FORT CAMBRIDGE"="FORT CAMBRIDGE",
  "FORTCAMBRIDGE"="FORT CAMBRIDGE",
  "TAL-VIRTÙ"="RABAT",
  "BIRGUMA"="ST. PAUL'S BAY",
  "SAN PAWL"="ST. PAUL'S BAY",
  "VICTORIA GARDENS"="TAL-IBRAĠ",
  "GHADIRA"="GĦADIRA",
  "TAS-SILĠ"="MARSAXLOKK",
  "FORT"="FORT CAMBRIDGE",
